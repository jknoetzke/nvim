...
local colors = {
  ...
  comment_grey        = { gui = '#ff5370', cterm = 252,  cterm16 = 15 },
...
hl.common = {
  ...
  DiffChange =        { fg = colors.yellow, underline = true },
  DiffText =          { fg = colors.bg, bg = colors.dark_yellow, bold = true },
...
-- LSP colors
hl.lsp = {
  LspReferenceText  = { fg = colors.fg, underline = true },
  LspReferenceWrite = { fg = colors.fg, underline = true },
  LspReferenceRead  = { fg = colors.fg, underline = true },
}
